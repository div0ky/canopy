...
Production runtime and application commands load `dist/app.config.js`, `.doxa/manifest.json`, and
...
example builds one shared image, exposes the framework-owned web health endpoint, keeps migrations
