...
First-party fakes capture Canopy messages and return provider-independent acceptances. Adapter tests
...
execution, stage a `canopy_delivery_messages` row and `canopy.queue` outbox envelope atomically, and
