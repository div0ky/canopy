import type { Observation } from '@canopy/core'
import { Pool } from 'pg'
...
export class UndergrowthStore {
  ...
  constructor(connectionString: string) {
    this.#pool = new Pool({ connectionString, application_name: 'canopy-undergrowth-ui' })
  }

  async executions(query: UndergrowthQuery = {}): Promise<readonly UndergrowthExecution[]> {
    ...
    const result = await this.#pool.query<{
      ...
      WITH eligible AS (
        ...
        FROM canopy_undergrowth_observations observation
