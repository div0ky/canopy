...
async function makeApplication(directory: string, rawName: string): Promise<void> {
  ...
  const files: Readonly<Record<string, string>> = {
    ...
    'src/app/http/home.route.ts': `import { type HttpRequest, Logger, Route } from '@canopy/core'\n\nexport class HomeRoute extends Route {\n  static override readonly id = 'home'\n  static override readonly access = 'public'\n  readonly method = 'GET'\n  readonly path = '/'\n  constructor(private readonly logger: Logger) { super() }\n  handle(_request: HttpRequest): Response { this.logger.info('Home visited'); return Response.json({ application: '${packageName}', framework: 'Canopy' }) }\n}\n`,
