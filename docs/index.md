...
Canopy documentation is organized by what a developer is trying to accomplish:

- [Getting started](getting-started/index.md) creates and runs an application.
...
The [Canopy Manifesto](../manifesto/index.md) remains the design authority. User documentation
