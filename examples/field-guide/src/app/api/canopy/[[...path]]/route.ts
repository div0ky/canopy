...
const forwardedHeaders = ["accept", "authorization", "content-type", "cookie", "origin", "user-agent"];
const responseHeadersToRemove = new Set(["connection", "content-encoding", "content-length", "transfer-encoding"]);
