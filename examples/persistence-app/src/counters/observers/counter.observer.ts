...
export class CounterObserver extends Observer<Counter> {
  ...
  creating(model: Counter): void { this.record('creating', model) }
  updating(model: Counter): void { this.record('updating', model) }
  created(model: Counter): void { this.record('created', model) }
  updated(model: Counter): void { this.record('updated', model) }
  saved(model: Counter): void { this.record('saved', model) }
  committed(model: Counter): void { this.record('committed', model) }
