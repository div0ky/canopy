...
Describe the developer-visible result.
...
List focused evidence and the result of `pnpm verify`.

## Compatibility and risk

Describe public API, manifest, migration, security, deployment, or behavioral impact. State
remaining risk explicitly.
